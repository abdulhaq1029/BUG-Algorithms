...
def main():
    ...
    sub_laser = rospy.Subscriber("/new/laser/scan", LaserScan, clbk_laser)
    ...
    while not rospy.is_shutdown():
        ...
        print("initial_pose= {0}, {1} current_pose={2}, {3} shortest_obst_pos={4}, {5} intermediate_pose={6}, {7}".format(
                                initial_position.x, initial_position.y,
                                current_pos.x, current_pos.y,
                                shortest_obst_pos.x, shortest_obst_pos.y,
                                intermediate_position.x, intermediate_position.y))
        print(time_sec)
